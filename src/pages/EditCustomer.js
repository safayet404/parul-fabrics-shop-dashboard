...
import { createCustomer, getCustomers, getSingleCustomer, updateCustomer } from '../features/customer/customerSlice';
...
const EditCustomer = () => {
    ...
    const singleCustomer_state = useSelector((state) => state.customer.singleCustomer)
    console.log(singleCustomer_state);
    const {name,email,mobile,address} = singleCustomer_state
  ...
  return (
    <div>
        <h3 className='mb-4'> {getCustomerId !== undefined ? "Edit Customer Information" : "Add Customer"}</h3>
